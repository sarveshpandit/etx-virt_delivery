...
[NOTE]
====
Many of the commands in this module use variable substitutions, which will identified by curly braces.  For example, you will need to replace `{your_github_user}` with your GitHub user name in the next section.
====
